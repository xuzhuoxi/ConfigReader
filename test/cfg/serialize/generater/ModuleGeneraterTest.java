...
public class ModuleGeneraterTest {
	...
	@Test
	public void testSerializeTS() throws SheetDefineException {
		...
		IContentGenerater cg = LangFileGenerater.getModuleGenerater(OutputDefineLangType.TypeScript,
	...
	@Test
	public void testSerializeJava() throws SheetDefineException {
		String basePath = BasePathUtils.getBasePath(this.getClass());
		String filePath = basePath + "/source/cfg_building.xls";
		WorkbookInfo info = new WorkbookInfo(filePath);
		info.loadSheetInfos();
